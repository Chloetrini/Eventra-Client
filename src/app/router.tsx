...
import CreateEventLayout from "@/routes/dashboard/create-event/layout";
import DashBoardLayout from "@/routes/dashboard/layout";
import { RequireOrganizer } from "@/components/guards/require-organizer";
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            lazy: async () => {
              const { default: Component } =
                await import("@/routes/main/event-details");
              return { Component };
            },
          },
          {
          ...
          },
          {
            ...
            lazy: async () => {
              const { default: Component } =
                await import("@/routes/main/organizers");
              return { Component };
            },
          },
          {
...

          {
            ...
            children: [
              ...
              },
              {
                ...
                lazy: async () => {
                  const { default: Component } =
                    await import("@/routes/main/refund-request");
                  return { Component };
                },
              },
            ],
        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                lazy: async () => {
                  const { default: Component } =
                    await import("@/routes/admin/approvals/index");
                  return { Component };
                },
              },
              {
                ...
                children: [
                  {
                    ...
                    lazy: async () => {
                      const { default: Component } =
                        await import("@/routes/admin/organizers/index");
                      return { Component };
                    },
                  },
                  {
                    ...
                    lazy: async () => {
                      const { default: Component } =
                        await import("@/routes/admin/organizers/detail");
                      return { Component };
                    },
                  },
                ],
                ...
                children: [
                  {
                    ...
                    lazy: async () => {
                      const { default: Component } =
                        await import("@/routes/admin/refunds/index");
                      return { Component };
                    },
                  },
                  {
                    ...
                    lazy: async () => {
                      const { default: Component } =
                        await import("@/routes/admin/refunds/detail");
                      return { Component };
                    },
                  },
                ],
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    lazy: async () => {
                      const { default: Component } =
                        await import("@/routes/admin/reports/full-details");
                      return { Component };
                    },
                  },
                ],
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    lazy: async () => {
                      const { default: Component } =
                        await import("@/routes/admin/enquiries/detail");
                      return { Component };
                    },
                  },
                ],
                  ...
                  },
                  {
                    ...
                    handle: {
                      seo: {
                        title: "User details",
                        description:
                          "View a user's account, orders and status.",
                      },
                    },
                    lazy: async () => {
                      const { default: Component } =
                        await import("@/routes/admin/users/detail");
                      return { Component };
                    },
                  },
                ],
        ...
        children: [
          {
            ...
            children: [
                ...
                children: [
                  {
                    ...
                    handle: {
                      seo: {
                        title: "Events",
                        description:
                          "Manage your events, from draft to sold out.",
                      },
                    },
                    lazy: async () => {
                      const { default: Component } =
                  ...
                  },
                  {
                    ...
                    lazy: async () => {
                      const { default: Component } =
                        await import("@/routes/dashboard/event-details");
                      return { Component };
                    },
                  },
                ],
              ...
              // ─── Check-In Route ──────────────────────────────────────
              {
                ...
                lazy: async () => {
                  const { default: Component } =
                    await import("@/routes/dashboard/check-in/index");
                  return { Component };
                },
                handle: {
                  seo: {
              ...
              },
              {
                ...
                handle: {
                  seo: {
                    title: "Payouts",
                    description:
                      "Track earnings per event and your payout history.",
                  },
                },
                lazy: async () => {
                  const { default: Component } =
