...
const AdminTopbar: React.FC<AdminTopbarProps> = ({ onMenuClick, title }) => {
    ...
    // Same skeleton pattern as SideBar.tsx — show the placeholder until the
    // current user (avatar/name) is resolved rather than flashing an empty
    // avatar in for a beat.
    if (isAuthLoading) return <TopBarSkeleton />;
