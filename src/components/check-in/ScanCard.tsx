    ...
    <div className="bg-[#E6F4EA] p-4 rounded-xl flex items-center gap-4 shadow-sm animate-in fade-in slide-in-from-top-2 duration-300">
       ...
       <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
             <h4 className="font-bold text-gray-900 text-sm truncate">Valid · Admit 1</h4>
          </div>
          <p className="text-gray-700 text-sm truncate">
             {attendee.name} 
             {attendee.tableNumber && <span className="text-gray-500 ml-1">· Table ({attendee.tableNumber})</span>}
          </p>
