...
import AttendeeListItem from '@/components/check-in/attendee-list-item';
...
export { default as CheckInManualLookup } from '@/components/check-in/check-in-manual-lookup';