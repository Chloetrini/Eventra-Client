...
export const DottedGlowBackground = ({
  ...
  useEffect(() => {
    ...
    // Runs whenever the container's actual box size changes (Tailwind class
    // change, responsive breakpoint, content reflow, or a window resize that
    // affects this element) — resizes the canvas AND rebuilds the dot grid
    // so it always fills the current container size.
