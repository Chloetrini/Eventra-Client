import { getDerivedAccountStatus } from "@/lib/onboarding-store";
...
// Simulate API call
export const fetchDashboardMock = async (): Promise<DashboardData> => {
  await new Promise(resolve => setTimeout(resolve, 800));
  return {
    organization: { name: 'Lagos Live Co.', logo: null },
    accountStatus: getDerivedAccountStatus(),
    stats: mockStats,
