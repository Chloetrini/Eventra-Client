...
import { EventLineUp } from "@/components/event-details/event-line-up";
...
import { GoodToKnow } from "@/components/event-details/good-to-know";
import { RelatedEvents } from "@/components/event-details/related-events";
import { FreeEventTicket } from "@/components/event-details/free-event-ticket";
import { PaidEventTicket } from "@/components/event-details/paid-event-ticket";
import { useSavedEvents } from "@/hooks/events/use-saved-events";

import PageWrapper from "@/components/layout/page-wrapper";
import { useAuth } from "@/context/auth-context";
import { getExploreUrl } from "@/lib/explore-history";
import { useEvent, useEventTickets } from "@/hooks/events/use-event";
