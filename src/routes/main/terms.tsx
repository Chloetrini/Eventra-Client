        ...
        <div className="min-h-screen bg-background py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="prose prose-invert max-w-none space-y-6 text-foreground/80">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-foreground mb-4">4. Ticket Purchases</h2>
                        <p>
                    ...
                    <section>
                        ...
                        <p>
                            If you have any questions about these Terms, please contact us at contact@eventra.com or visit our <a href="/contact" className="text-primary hover:underline">contact page</a>.
                        </p>
                    </section>
                </div>
            </div>
