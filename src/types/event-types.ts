...
export const CATEGORIES = [
  'Concerts', 'Parties', 'Conferences', 'Comedy',
  'Sports', 'Arts & Theatre', 'Food & Drink', 'Tech'
] as const;
...
// --------------------------------------------
// Event Schema (moved here to avoid circular imports)
// --------------------------------------------
...
export const DATE_WINDOWS = {
  any: { label: "Any time", test: () => true },
  today: { label: "Today", test: (date: Date, today: Date) => date >= today && date < new Date(today.getTime() + DAY_MS) },
  weekend: { label: "This weekend", test: (date: Date, today: Date) => {
  ...
  week: { label: "This week", test: (date: Date, today: Date) => date >= today && date < new Date(today.getTime() + 7 * DAY_MS) },
  month: { label: "This month", test: (date: Date, today: Date) => date >= today && date < new Date(today.getTime() + 30 * DAY_MS) },
} as const;
...
export const SORT_OPTIONS = { trending: "Trending", date: "Date", price: "Price: low to high" } as const;
